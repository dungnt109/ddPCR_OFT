...
qc.names <- c("Min events per well ($\\ge\\!\\!$ 8000)", "Min FU GUS conc. (copies/uL; >5000, GOOD; 1000-5000; ACCEPTABLE; <1000 POOR)", "Assay controls for marker", "\\hspace{0.5cm}Positive (Dx marker conc., $\\ge\\!\\!$ 10 copies/uL)", "\\hspace{0.5cm}NTC (H2O marker conc., <=0.3 copies/uL)", "Assay Controls for GUS", "\\hspace{0.5cm}Positive (HL60 GUS conc., $\\ge\\!\\!$ 30 copies/uL)", "\\hspace{0.5cm}NTC (H2O GUS conc., <=0.1 copies/uL)", "\\textbf{Overall QC result}")
