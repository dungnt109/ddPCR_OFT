...
if (min.events.per.well >= 8000){
	...
	min.events.per.well.status <- "\\textcolor{orange}{ALERT}"
}
...
if (min.events.per.well >= 8000 && min.fu.gus.conc.perwell >= 1000 && max.h2o.marker.con.perwell <= 0.1 && min.hl60.gus.con.perwell >= 30 && max.h2o.gus.con.perwell <= 0.1 ){
